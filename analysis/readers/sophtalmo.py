...
reader = Reader(
    ...
    [
        Field(
            "nameBirth",
            rf"Contacts - Softalmo [0-9\.]+ - {patterns.name} {patterns.name}"
            + rf" - (\d+) - {patterns.date}",
        ...
        Field("autorefract OG key", "OG:", onRightof="autorefract OD key"),
        # Refractometer
        ...
        Field("refraction OG key", "OG:", onRightof="refraction OD key"),
        Field(
        ...
        Field("glasses OG key", "OG:", onRightof="glasses OD key"),
        Field(
            "glasses OG ADD key",
            "Addition :",
        ...
        # Acuity
        Field("acuity", "Acuité", below="refraction OD key", regionHeight=5),
        Field(
            "acuity OD far key", "de loin", onRightof="acuity", regionWidth=50
        ),
        Field(
            "acuity OD near key",
            "de près",
        ...
        Field(
            "acuity OG far key",
            "de loin",
            # search even if OD near not present
            onRightof="acuity OD far key",
        ),
        Field("acuity OG near key", "de près", onRightof="acuity OG far key"),
        # IOP
        Field("IOP", r"^TO$"),
        Field(
            "IOP OD key",
        ...
        Field("IOP OG key", "OG:", onRightof="IOP OD key"),
    ],
)
