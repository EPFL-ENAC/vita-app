import argparse
from readers.list import names as formatNames
from command.visualizeOcr import visualizeOcr
from command.generateStructuredOutput import generateStructuredOutput
